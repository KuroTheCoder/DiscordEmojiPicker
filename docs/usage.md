...
A shortcode is just `:filename:` — for example `:party-parrot:` inserts `emoji/party-parrot.gif`.
...
- Images in `emoji/animals/` belong to the **animals** set; images in `emoji/` belong to the general set.
